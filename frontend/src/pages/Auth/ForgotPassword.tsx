          ...
          {status === 'success' ? (
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
                {t('auth.resetLinkIf')} <span className="text-white font-medium">{email}</span> {t('auth.resetLinkRegistered')}
              </p>
              <p className="text-xs text-slate-500 mb-6">{t('auth.checkSpamFolder')}</p>
              <Link
                to="/login"
