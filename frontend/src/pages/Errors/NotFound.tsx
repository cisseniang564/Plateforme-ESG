...
export default function NotFound() {
  ...
  return (
    <div role="alert" className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center px-4">
      <div className="max-w-lg w-full text-center">
        {/* Big 404 */}
        <div className="relative mb-8">
          <p className="text-[10rem] font-black text-slate-100 leading-none select-none" aria-hidden="true">
            404
          </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl px-8 py-5 border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-sm font-semibold text-slate-500 uppercase tracking-widest">ESG Flow</p>
                  <p className="text-lg font-bold text-slate-800">{t('notFoundPage.title')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          >
            {isAuthenticated ? t('notFoundPage.dashboardBtn') : t('notFoundPage.loginBtn')}
          </button>
        </div>
