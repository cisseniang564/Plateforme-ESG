...
class ESGRisk(Base, UUIDMixin, TenantMixin, TimestampMixin):
    ...
    materiality_issue_id: Mapped[Optional[UUID]] = mapped_column(
    ForeignKey("materiality_issues.id"), nullable=True
)
