        ...
        {calculating ? (
          ...
          <Card>
            ...
            <div className="flex items-center gap-6 mb-6">
              <div className={`text-5xl font-bold px-5 py-3 rounded-xl border-2 ${GRADE_COLORS[result.rating] || 'text-gray-600 bg-gray-50 border-gray-200'}`}>
                {result.rating}
              </div>
              <div>
            ...
            <Button onClick={() => navigate(`/scores/${result.id}`)} className="w-full">
